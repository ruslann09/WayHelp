...
//                mLoaderCallback);
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        for (int i = 0; i < facesArray.length; i++) {
            ...
            Imgproc.putText(mRgba, "[" + center.x + "," + center.y + "]",
                    ...
                    Imgproc.FONT_HERSHEY_SIMPLEX, 0.7, new Scalar(255, 255, 255,
                            255));
    ...
    private class EyesTracker extends Tracker<Face> {
        ...
        public void onUpdate(Detector.Detections<Face> detections, final Face face) {
            if (face.getIsLeftEyeOpenProbability() > THRESHOLD || face.getIsRightEyeOpenProbability() > THRESHOLD) {
                ...
                if (!isSignalStarted) {
                    ...
                    releaseMP(mediaPlayer);
                    mediaPlayer = MediaPlayer.create(FdActivity.this, R.raw.alarm);
        ...
        public void onMissing(Detector.Detections<Face> detections) {
            ...
            releaseMP(mediaPlayer);
            mediaPlayer = MediaPlayer.create(FdActivity.this, R.raw.alarm_infinity);
            mediaPlayer.setLooping(true);
            mediaPlayer.start();
        }
